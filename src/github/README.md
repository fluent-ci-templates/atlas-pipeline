...
The following command will generate a `.github/workflows/atlas-migrate.yml` file in your project:

```bash
fluentci gh init -t atlas_pipeline
```

Or, if you already have a `.fluentci` folder (generated from `fluentci init -t atlas`) in your project:
